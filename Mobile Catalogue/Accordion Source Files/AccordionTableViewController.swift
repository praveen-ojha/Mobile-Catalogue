...
open class AccordionTableViewController: UITableViewController {
    ...
    //// To remember presented Cell
    open var presentedCellIndexPath: IndexPath?
    ...
    */
    ...
    open override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        if let cell = tableView.cellForRow(at: indexPath) as? AccordionTableViewCell {
            ...
            if presentedCellIndexPath != nil {
                if indexPath != presentedCellIndexPath {
                    toggleCell(tableView.cellForRow(at: presentedCellIndexPath!) as! AccordionTableViewCell, animated: true)
                }
            }
            if cell.expanded {
                presentedCellIndexPath = indexPath
            }
        }
    }
